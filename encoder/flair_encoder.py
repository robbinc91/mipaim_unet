...
def flair_encoder(img_input_FLAIR, IMAGE_ORDERING):
    ...
    conv_1_FLAIR = Conv3D(filters=16, kernel_size=(3, 3, 3), padding='same', activation='relu',
                          name="CONV3D_1_FLAIR", dilation_rate=(1, 1, 1), data_format=IMAGE_ORDERING)(img_input_FLAIR)
    conv_11_FLAIR = Conv3D(filters=16, kernel_size=(3, 3, 3), padding='same', activation='relu',
    ...
    conv_2_FLAIR = Conv3D(filters=32, kernel_size=(3, 3, 3), padding='same', activation='relu',
                          name="CONV3D_2_FLAIR", dilation_rate=(1, 1, 1), data_format=IMAGE_ORDERING)(maxpool_1_FLAIR)
    conv_21_FLAIR = Conv3D(filters=32, kernel_size=(3, 3, 3), padding='same', activation='relu',
    ...
    conv_3_FLAIR = Conv3D(filters=64, kernel_size=(3, 3, 3), padding='same', activation='relu',
                          name="CONV3D_3_FLAIR", dilation_rate=(1, 1, 1), data_format=IMAGE_ORDERING)(maxpool_2_FLAIR)
    conv_31_FLAIR = Conv3D(filters=64, kernel_size=(3, 3, 3), padding='same', activation='relu',
                           name="CONV3D_31_FLAIR", dilation_rate=(2, 2, 2), data_format=IMAGE_ORDERING)(conv_3_FLAIR)
    conv_32_FLAIR = Conv3D(filters=128, kernel_size=(3, 3, 3), padding='same', activation='relu',
