...
def encode_inception(img_input,
    ...
    layer_2 = fn(layer_2, filters_dim[1], IMAGE_ORDERING=IMAGE_ORDERING, only_3x3_filters=only_3x3_filters)

    layer_3 = MaxPool(pool_size=3, strides=2, padding='same', data_format=IMAGE_ORDERING)(layer_2)
    layer_3 = fn(layer_3, filters_dim[2], IMAGE_ORDERING=IMAGE_ORDERING, only_3x3_filters=only_3x3_filters)

    layer_4 = MaxPool(pool_size=3, strides=2, padding='same', data_format=IMAGE_ORDERING)(layer_3)
    layer_4 = fn(layer_4, filters_dim[3], IMAGE_ORDERING=IMAGE_ORDERING, only_3x3_filters=only_3x3_filters)

    layer_5 = MaxPool(pool_size=3, strides=2, padding='same', data_format=IMAGE_ORDERING)(layer_4)
    layer_5 = fn(layer_5, filters_dim[4], IMAGE_ORDERING=IMAGE_ORDERING, only_3x3_filters=only_3x3_filters)
