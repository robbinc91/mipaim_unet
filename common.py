...
THALAMUS_LEFT_ROOT = './datasets/sevilla24/'
...
CERSEGSYS_7_SHAPE=(1, 160, 128, 96)
CERSEGSYS_7_BRAINSTEM_SHAPE=(1, 80, 80, 96)
CERSEGSYS_7_CEREBELLUM_SHAPE=(1, 160, 96, 96)
CERSEGSYS_7_CEREBELLUM_SHAPE_REDUCED=(1, 128, 80, 96)

THALAMUS_LEFT_SHAPE = (1, 48, 64, 64)
