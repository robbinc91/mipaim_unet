...
cersegsys_train_prt_augm = [i for i in range(1, 301)]# [i for i in range(1, 601)]  # Added new images
cersegsys_dev_prt_augm = [i for i in range(601, 681)]# 761
