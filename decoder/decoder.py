...
def decode(inputs, outputs, conv_21, conv_32, IMAGE_ORDERING='channels_first'):
    ...
    conv_all = Conv3D(filters=256, kernel_size=(3, 3, 3), padding='same', activation='relu', name='CONV3D_all', data_format=IMAGE_ORDERING)(concat_all)
    conv_all = Conv3D(filters=256, kernel_size=(3, 3, 3), padding='same', activation='relu', name='CONV3D_all_2',
                      data_format=IMAGE_ORDERING)(conv_all)

    ## decode
    convt_1 = Conv3DTranspose(128, kernel_size=(2, 2, 2), strides=(2, 2, 2), name="CONV3DT_1", activation='relu', data_format=IMAGE_ORDERING)(conv_all)
    concat_1 = Concatenate(axis=1)([convt_1] + conv_32_array)
    conv_4 = Conv3D(filters=64, kernel_size=(3, 3, 3), padding='same', activation='relu', name="CONV3D_4", data_format=IMAGE_ORDERING)(concat_1)
    conv_41 = Conv3D(filters=64, kernel_size=(3, 3, 3), padding='same', activation='relu', name="CONV3D_41", data_format=IMAGE_ORDERING)(conv_4)
    convt_2 = Conv3DTranspose(32, kernel_size=(2, 2, 2), strides=(2, 2, 2), name="CONV3DT_2", activation='relu', data_format=IMAGE_ORDERING)(conv_41)
    concat_2 = Concatenate(axis=1)([convt_2] + conv_21_array)
    conv_5 = Conv3D(filters=32, kernel_size=(3, 3, 3), padding='same', activation='relu', name="CONV3D_5",  data_format=IMAGE_ORDERING)(concat_2)
    conv_51 = Conv3D(filters=32, kernel_size=(3, 3, 3), padding='same', activation='relu', name="CONV3D_51", data_format=IMAGE_ORDERING)(conv_5)
    convt_3 = Conv3DTranspose(32, kernel_size=(2, 2, 2), strides=(2, 2, 2), name="CONV3DT_3", activation='relu', data_format=IMAGE_ORDERING)(conv_51)
    conv_6 = Conv3D(filters=16, kernel_size=(3, 3, 3), padding='same', activation='relu', name="CONV3D_6", data_format=IMAGE_ORDERING)(convt_3)
