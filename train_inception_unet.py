...
if __name__ == '__main__':
    ...
    history = model_.fit(X=X, y=y, validation_data=(X_val, y_val), epochs=EPOCHS,
                         callbacks=keras.callbacks.ModelCheckpoint(
                             'weights/unet_3d-label' + str(label) + '/Model.val_dice_coefficient={val_dice_coefficient:.5f}.h5',
